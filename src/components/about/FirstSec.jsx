...
import bigImg from "../../assets/aboutUs/about1.jpg"; // large image
import smallImg from "../../assets/aboutUs/about2.jpg"; //  small image
          ...
          <div className="flex flex-col justify-center order-2 lg:order-1 lg:col-span-7 pr-0 lg:pr-10">
            ...
            <div className="space-y-4 text-content text-[16px] leading-relaxed">
              <p>
                ...
                Plant & Equipment Installation, Civil & Contractual Works,
                Laundry & Kitchen Services, Environmental & Waste Management
                Services, Building Maintenance Services, and General Trading,
                among others.
              </p>
              <p>
              ...
              <p>
                ...
                stay ahead of the curve, offering the latest industry
                advancements at competitive prices and value. Trust us to
                fulfill your needs as we embark on our journey toward
                excellence.
              </p>
            </div>
          </div>
